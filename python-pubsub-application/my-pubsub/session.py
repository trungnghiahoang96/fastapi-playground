...
from pubsub import follow, post_message

# from pubsub import follow, post_message, set_user
...
if __name__ == '__main__':
    ...
    # from pubsub import (age, check_user, followers, following, get_followed,
    #                     get_followers, get_user, hashtag_index, posts,
    #                     posts_by_user, posts_for_user, search, user_info)

    # assert check_user('raymondh', password='superman123')
    # assert not check_user('davin', password='passw0rd')

    from pubsub import (follow, followers, following, get_followed,
                        get_followers, get_posts, posts, posts_by_user,
                        posts_for_user, search)
